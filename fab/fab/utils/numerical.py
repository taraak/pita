...
def MC_estimate_true_expectation(
    distribution: Union[torch.distributions.Distribution, fab_distribution],
...
def importance_weighted_expectation(
    f: Callable[[torch.Tensor], torch.Tensor], x: torch.Tensor, log_w: torch.Tensor
) -> torch.Tensor:
