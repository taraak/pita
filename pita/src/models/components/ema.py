...
class EMA(torch.nn.Module):
    ...
    def forward_energy(self, *args, **kwargs):
        return self.model.forward_energy(*args, **kwargs)

    def denoiser_and_energy(self, *args, **kwargs):
        return self.model.denoiser_and_energy(*args, **kwargs)

    def reverse(self, *args, **kwargs):
        return self.model.reverse(*args, **kwargs)

    def denoiser(self, *args, **kwargs):
        return self.model.denoiser(*args, **kwargs)

    def reinitialize(self, *args, **kwargs):
        return self.model.reinitialize(*args, **kwargs)
